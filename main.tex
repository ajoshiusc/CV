...
\hypersetup{
  ...
  pdfcreator={$ $Id: anand_resume.tex,v 1.5 2020-10-15 22:21:04 ajoshi Exp $ $},
...
%    \begin{multicols}{2}
    \begin{itemize}
\item Judge, Ming Hseih Research Festival, USC, 2021.    
\item Associate editor / Meta-reviewer, ISBI 2022.    
...
\section{\bf TEACHING}
\begin{itemize}
\item \textbf{Instructor,} EE575: Computational Differential Geometry for Engineers, Spring 2016, Spring 2020, Spring 2022 \textbf{(Developed curriculum based on EE599 and taught the class)}. 
...
Project Period: 8/30/2018 - 8/29/2021\\
Total cost: \$763,653\\
Project Role: PI\\
Effort: 3.6 calendar\\
...
\begin{enumerate}
    ...
    \item Akrami H, \textbf{Joshi AA}, Li J, Aydore S, Leahy RM, Robust Variational Autoencoder Using Robust Divergence, Knowledge-Based Systems, 107886, 2022.

    \item Shahabi H, Taylor K, Hirfanoglu T, Koneru S, Bingaman W, Kobayashi K, Kobayashi M, \textbf{Joshi AA}, Leahy RM, Mosher JC, Bulacio J, Nair D.. Effective connectivity differs between focal cortical dysplasia types I and II. Epilepsia. 2021; 62: 2753– 2765. 
    
    \item Taylor KN, \textbf{Joshi AA}, Hirfanoglu T, Grinenko O, Liu P, Wang X, A. Gonzalez‐Martinez J, Leahy RM, Mosher JC, Nair DR. Validation of Semi‐Automated Anatomically Labeled SEEG Contacts in a Brain Atlas for Mapping Connectivity in Focal Epilepsy. Epilepsia Open, 2021.
    ...
    \item Taylor K, \textbf{Joshi AA}, Li J, Gonzalez-Martinez J, Wang X, Leahy RM, Nair D, Mosher J, {The FAST Graph: A Novel Framework for the Anatomically-Guided Visualization and Analysis of Cortico-Cortical Evoked Potentials}, Epilepsy Research, Res. 2020 Mar;161:106264, 2020.
...
\item \textbf{Joshi AA}, Bhushan C, Salloum R, Wisnowski JL, Shattuck DW, Leahy RM, {An Anisotropic Laplace Equation Method for Cortical Thickness Measurement}, NeuroImage, submitted, 2021.
...
\item Akrami H, Leahy RM, Irimia A, Kim P, Heck C, \textbf{Joshi AA}, {Neuroanatomic markers of post-traumatic epilepsy based on magnetic resonance imaging and machine learning}, AJNR, (submitted) (preprint : medRxiv 2020.07.22.20160218).

\item Akrami H, \textbf{Joshi AA}, Li J, Aydore S, Leahy RM, {Statistical Approach for Robust Quantile Regression}, NeuroIPS workshop WrongModels 2021.
...
\begin{enumerate}
    ...
    \item Akrami H, \textbf{Joshi AA}, Leahy RM, Quantile Regression for Uncertainty Estimation in VAEs with Applications to Brain Lesion Detection, Proc. IPMI 2021 pp. 689-700.
    
    \item Medani T, Garcia-Prieto J, Tadel F, Schrader S, Antonakakisc M, \textbf{Joshi AA}, Engwere C, Wolters CR, Mosher JC, Leahy RM, Realistic head modeling of electromagnetic brain activity: an integrated Brainstorm-DUNEuro pipeline from MRI data to the FEM solutions, SPIE Medical Imaging 2021, vol. 11595, pp. 1159554.


    \item \textbf{Joshi AA}, Choi SY, Li J, Akrami H, Leahy RM, A pairwise approach for fMRI group studies using the BrainSync Transform, SPIE medical imaging 2021, vol. 11596, pp. 115960G.
    
    \item Akrami H, Irimia A, Cui W, \textbf{Joshi AA}, Leahy RM, Prediction of Posttraumatic Epilepsy using Machine Learning, SPIE medical imaging 2021, vol. 116001, pp. 116001Q.
    
    \item Sridhara SN, Krishnamurthy V, Akrami H, \textbf{Joshi AA}, Bias Field correction in 3D-MRIs using Convolutional Autoencoders, SPIE medical imaging 2021, vol. 11596, pp. 115962H.
...
\begin{enumerate}
    ...
    \item Akrami H, Irimia A, Cui W, Joshi A, Leahy R, A comparative study of post-traumatic epilepsy prediction from fMRI using anatomical and functional features., AES 2021.

    \item Joshi A, Tadel F, Taylor K, Akrami H, Nair D, Leahy R, Automatic labeling of individual brains with multiple parcellation scemes. AES 2021.  
...
\begin{enumerate}
   \item Medani T, Mosher JC, \textbf{Joshi AA}, Taylor KN, Nair DR, Wolters CH, and Leahy RM, SEEG source analysis of intracranial stimulation with realistic head modeling: A validation study, OHBM 2022.
   \item \textbf{Joshi AA}, Tadel F, Taylor KN, Medani T, Nair DR, Leahy RM, SVReg-MultiParc:  A  Method for  Automated Labeling  of  Brains  with Multiple  Parcelation  Schemes, OHBM 2022.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item \textbf{Joshi AA}, Choi SY, Akrami H, Leahy RM, fMRI-Kernel Regression: A Kernel-based Method for Pointwise Statistical Analysis of rs-fMRI for Population Studies.
\end{enumerate}
