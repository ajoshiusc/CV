...
Funding Agency: Collaborative Research in Computational Neuroscience - NSF \\
Title: Methodology development for fMRI signal analysis during resting, self-paced activity, and complex naturalistic stimuli \\
Total Cost:  \$1,085,068 \\
Project Role: PI (joint with Kaplan J)\\
...
\begin{enumerate}
 ...
 \item Foster BH, Shaw CB, Boutin RD, \textbf{Joshi AA}, Bayne CO, Szabo RM, Chaudhari AJ, {A Principal Component Analysis-based Framework for Statistical Modeling of Bone Displacement During Wrist Maneuvers}, Journal of Biomechanics, Accepted 2019.
\end{enumerate}
...
\begin{enumerate}
\item \textbf{Joshi AA}, Li J, Akrami H, Leahy RM, {Predicting cognitive scores from resting fMRI data and geometric features}, Proc. SPIE Medical Imaging: Image Processing, San Diego, Feb. 2019. (Accepted).
...
\begin{enumerate}
    ...
    \item Zingg B, Gou L, Hintiryan H, Lee D, \textbf{Joshi AA}, Yamashita S, Ng Q, Lee BW, Mena C, Swanson LW, Toga AW and Dong H, {Toward a Mouse Connectome: A High-throughput Approach for the Characterization of Long-range Connectivity in the Mouse Brain}. UCLA Neurology science day 2011. [Marr Prize]
