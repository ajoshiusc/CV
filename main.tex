...
\item Served as Directed research mentor for 4 graduate students in Fall 2015.
\end{itemize}

\section{\bf TEACHING}
\begin{itemize}
\item EE599: Computational Differential Equations for Engineers, Spring 2015.
\item EE599: Computational Differential Equations for Engineers, Spring 2014.
\item EE575: Computational Differential Equations for Engineers, Fall 2016.
\end{itemize}
...
Tuvblad C, Niv S, Ashrafulla S, \textbf{Joshi AA}, Raine A, Leahy RM, Baker LA, Relationships of Alpha, Beta, and Theta EEG Spectra Properties with Aggressive and Nonaggressive Antisocial Behavior in Children and Adolescents, American Journal of Psychology, Vol. 131(4), pp. 429-437, 2018.

\textbf{Joshi AA}, Chong M, Li J, Choi S, Leahy RM, Are you thinking what I'm thinking? Synchronization of resting fMRI time-series across subjects, NeuroImage, Vol 172, pp 740-752, 2018.

Foster B, \textbf{Joshi AA}, Borgese M, Abdelhafez Y, Boutin RD, Chaudhari AJ, WRIST: A WRist Image Segmentation Toolkit for carpal bone delineation from MRI, Computerized Medical Imaging and Graphics 63, pp. 31-40, 2017.
...
\textbf{Joshi AA}, Leahy RM, Badawi RD, Chaudhari AJ, \textit{Registration-based Bone Morphometry for Shape Analysis of the Bones of the Human Wrist}, IEEE Trans. Med. Imag. , In press
...
\text{Joshi AA}, Li J, Chong M, Akrami H, Leahy RM, rfDemons: Resting fMRI-Based Cortical Surface Registration Using the BrainSync Transform. MICCAI (3) 2018: 198-205
...
Soyoung Choi, Adam M Bush, Matt Borzage, Anand Joshi, Thomas D Coates, Richard Leahy, John C Wood, \textit{Regional Susceptibility to Chronic Anemia in WM Microstructure Using Diffusion Tensor Imaging}, Blood, 128(22), 3640-3640. 

Suyash P Awate, Richard M Leahy, Anand A Joshi, \textit{Riemannian statistical analysis of cortical geometry with robustness to partial homology and misalignment}, International Conference on Medical Image Computing and Computer-Assisted Intervention, 237-246, 2016.

Abhijit J Chaudhari, Brent H Foster, Dylan A Noblett, Robert D Boutin, Robert M Szabo, Christopher O Bayne, Richard M Leahy, Nancy E Lane, Anand A Joshi, \textit{Sex Differences in Morphometry of the Anatomical Structures of the First Carpometacarpal Joint}, Journal of Womens Health, 25(9), 960-960, 2016.
...
Dutta J, Ahn S, \textbf{Joshi AA} and Leahy RM, \textit{Optimal Illumination Patterns for Fluorescence Tomography}, Proc. of IEEE ISBI 2009, 1275-1278.

\textbf{Joshi AA}, Chaudhari AJ, Shattuck DW, Dutta J, Leahy RM and Toga AW, \textit{Posture Matching and Elastic Registration of a Mouse Atlas to Surface Topography Range Data}, Proc. of ISBI 2009, 366-369.

\textbf{Joshi AA}, Leahy RM, Toga AW, Shattuck DW, \textit{A Framework for Brain Registration via Simultaneous Surface and Volume Flow}, Inf Process Med Imaging. 2009; 21:576-88.
...
\textbf{Joshi AA}, Shattuck DW, Thompson PM and Leahy RM, \textit{Brain Image Registration using Cortically Constrained Harmonic Mappings}, Inf Process Med Imaging. 2007; 4584,359-371.
...
\textbf{Joshi AA}, Shattuck DW, Thompson PM and Leahy RM, \textit{A Framework for Registration, Statistical Characterization and Classification of Cortically Constrained Functional Imaging Data}, Inf Process Med Imaging. 2005;  186-196,
...
\textbf{Joshi A}, Choi S, Chong M, Sonkar G, Gonzalez-Martinez G, Nair D, Shattuck D,  Damasio H, Leahy RM, USCBrain Atlas: A Volumetric and Surface Atlas Delineated by Anatomical and
Functional MRI, OHBM 2017.

Li J, Choi S, Leahy RM, Global PDF-based Non-Local means Filtering of Resting fMRI data, OHBM 2017.
...
Joshi S, Kim Y, \textbf{Joshi A}, Leahy RM,  Shattuck D, Reproducible TBM and ROI Analyses Using the BrainSuite Statistics Toolbox (BSS), OHBM 2017.
...
Xu L, Collignon O, Wang G, Kang Y, Lepore F, Shi J, Lao Y, \textit{Joshi AA}, Lepore N, Wang Y, \textit{Combining Thickness Information with Surface Tensor-based Morphometry for the 3D Statistical Analysis of the Corpus Callosum}, MICCAI, MFCA workshop 2013.

Choi S, Bhushan C, \textit{Joshi AA}, Raphel K, Tranel D, Shattuck DW, Haldar JP, Leahy RM, Damasio H, Wisnowski JL, \textit{Altered orbitofrontal tissue microstructure in patients with chronic anterior temporal lobe lesions}, OHBM 2013.

Shattuck DW, \textit{Joshi AA}, Haldar J, Bhushan C, Choi S, Krause A, Wisnowski J, Damasio H, Toga A, Leahy RM, \textit{New BrainSuite13 Tools for Image Segmentation, Registration , Connectivity Analysis and Visualization}, OHBM 2013.

\textit{Joshi AA}, Ashrafulla S, Shattuck DW, Damasio H, Leahy RM, \textit{Automated Analysis of the Shape of Sulcal Curves using the Anisotropic Helmholtz Equation}, OHBM 2013.

Eschenburg K, Villalon-Reina J, Nir T, Joshi AA, Terashima K, Jones M, Salamon N, de Bode S, Thompson PM, \textit{A Preliminary Graph Theory Analysis of 5 Hemispherectomized Children}, OHBM 2013.

Shattuck DW, Joshi AA, Haldar JP, Bhushan C, Choi S, Krause AC, Wisnowski JL, Toga AW and Leahy RM, \textit{Tools for Brain Image Segmentation, Registration, and Connectivity Analysis}, ISMRM 2013. 
...
Yang Y, Wang P, Baker LA, \textit{Joshi AA}, Joshi S, Narr KL, Raine A and Thompson PM, \textit{Variations in Frontal and Striatal Morphology Associate with Psychopathic Traits in Adolescents}, Organization for Human Brain Mapping, Beijing, China June 10-14, 2012.
...
Joshi AA, Brain Registration in BrainSuite, Childrens Hospital, Los Angeles, 2016.

Joshi AA, BrainSuite-Brainstorm Training session USC University Park Campus, Los Angeles, October 2015.

Joshi AA, BrainSuite – NeuroImaging Training Program 2015 UCLA Advanced Neuroimaging Summer Program, University of California, Los Angeles, August 2015.  

Joshi AA, Geometric methods for bran image registration and signal analysis, Centro de Investigación en Matemáticas, 2012.

Joshi AA, Geometric methods for brain image registration and signal analysis, University of Southern California, Signal and Image Processing Institute, 2011.

Geometric methods for brain image registration and signal analysis, University of California, Los Angeles, Dept. of Mathematics, Applied Math Colloquium, 2010.

Geometric methods for brain image registration, University of California, Los Angeles, Image Processing Seminar, 2010. 

Geometric methods for brain image registration, University of North Carolina at Chapel Hill, 2010. 

Medical image registration and analysis, Workshop at Children's Hospital, Los Angeles, 2009.

Geometric methods for brain image registration, SRI International, 2009. 

Medical image registration and analysis, DSP Experiments in MATLAB workshop at RSCOE, University of Pune, 2009.

Geometric methods for brain image registration, University of California, Davis, 2008.

Geometric methods for brain image registration and signal analysis, University of California, Los Angeles, LONI, CCB Presents, 2008.

Geometric methods for brain image registration and signal analysis, CSAIL, Massachutetts Institute of Technology, Biomedical Imaging and Analysis Seminar Series, 2008.

Simultaneous Surface and Volume Registration using Harmonic Maps, SIAM conference on Imaging Sciences, Minneapolis, 2006.
