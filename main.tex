...
\begin{enumerate}
    ...
    \item \textbf{Joshi AA}, Choi SY, Akrami H, Leahy RM, fMRI-Kernel Regression: A Kernel-based Method for Pointwise Statistical Analysis of rs-fMRI for Population Studies, Proc. IPMI 2021 submitted.

    \item Akrami H, \textbf{Joshi AA}, Leahy RM, Quantile Regression for Uncertainty Estimation in VAEs with Applications to Brain Lesion Detection, Proc. IPMI 2021 accepted.
    
    \item Medani T, Garcia-Prieto J, Tadel F, Schrader S, Antonakakisc M, \textbf{Joshi AA}, Engwere C, Wolters CR, Mosher JC, Leahy RM, Realistic head modeling of electromagnetic brain activity: an integrated Brainstorm-DUNEuro pipeline from MRI data to the FEM solutions, SPIE Medical Imaging 2021, in press.


    \item \textbf{Joshi AA}, Choi SY, Li J, Akrami H, Leahy RM, A pairwise approach for fMRI group studies using the BrainSync Transform, SPIE medical imaging 2021. In press.
    
    \item Akrami H, Irimia A, Cui W, \textbf{Joshi AA}, Leahy RM, Prediction of Posttraumatic Epilepsy using Machine Learning, SPIE medical imaging 2021. In Press
    
    \item Sridhara SN, Krishnamurthy V, Akrami H, \textbf{Joshi AA}, Bias Field correction in 3D-MRIs using Convolutional Autoencoders, SPIE medical imaging 2021. In press
